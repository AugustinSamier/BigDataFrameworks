...
st.write("The PE ratio (Price to Earnings ratio) which indicated the price investors are ready to pay for each unit (here $) generated by the company. This ratio is useful to know if investors trust a company and believe it will work.")
